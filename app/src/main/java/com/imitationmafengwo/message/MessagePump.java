...
public class MessagePump extends Thread {
    ...
    public MessagePump() {
        ...
        mMsgAndObserverList = new ArrayList<List<WeakReference<MessageCallback>>>(Collections.nCopies(Message.Type.values().length, null));
...
//        L.d("%s destroyed MessagePump", LogModuleName.MESSAGEPUMP);
    ...
    public void broadcastMessage(Message.Type msgType, Object data) {
        mMsgPump.put(Message.obtainMessage(msgType, data, 0,  Message.PRIORITY_NORMAL, null));
    }

    public void broadcastMessage(Message.Type msgType, Object data, int priority) {
        mMsgPump.put(Message.obtainMessage(msgType, data, 0, priority, null));
    }

    public void broadcastMessage(Message.Type msgType, Object data, int priority, Object sender) {
        mMsgPump.put(Message.obtainMessage(msgType, data, 0, priority, sender));
    }
